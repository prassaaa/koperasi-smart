...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create', href: '/dashboard/hero-sections/create' },
];
...
export default function HeroSectionsCreate() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('dashboard.hero-sections.store'));
    };
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Create New Hero Section</h1>
                        <p className="text-muted-foreground">
                            Add a new hero section for the website homepage
                        </p>
                    </div>
                ...
                <div className="grid gap-6 lg:grid-cols-3">
                    ...
                    <Card className="lg:col-span-2">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Fill in the information below to create a new hero section
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                                        ...
                                        <div key={index} className="grid gap-4 md:grid-cols-4 p-4 border rounded-lg">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <Input
                                                    ...
                                                    placeholder="Terdaftar Resmi"
                                                />
                                            </div>
                                            <div className="space-y-2">
                                                <Label>Color</Label>
                                                <Select value={badge.color} onValueChange={(value) => updateBadge(index, 'color', value)}>
                                                    <SelectTrigger>
                                                        <SelectValue />
                                                    </SelectTrigger>
                                                    <SelectContent>
                                            ...
                                            <div className="flex items-end">
                                                <Button type="button" variant="outline" size="sm" onClick={() => removeBadge(index)}>
