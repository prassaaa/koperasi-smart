...
import { ArrowLeft, Save, Users, Calendar, Star, Banknote, Building2, UserCheck } from 'lucide-react';

const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Dashboard', href: '/dashboard' },
    { title: 'Statistics', href: '/dashboard/statistics' },
    { title: 'Create', href: '/dashboard/statistics/create' },
];
...
export default function StatisticsCreate() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('dashboard.statistics.store'));
    };
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Create New Statistic</h1>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Fill in the information below to create a new statistic
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
