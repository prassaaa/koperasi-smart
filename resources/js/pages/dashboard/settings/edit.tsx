...
export default function SettingsEdit({ setting }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('dashboard.settings.update', setting.id));
    };
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Edit Setting</h1>
                        <p className="text-muted-foreground">
                            Update the configuration setting: {setting.label}
                        </p>
                    </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Update the information below to modify this setting
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
